...
DEFINE_FUNC_PTR_TYPE(glNamedBufferStorage);
DEFINE_FUNC_PTR_TYPE(glEnableVertexArrayAttrib);
DEFINE_FUNC_PTR_TYPE(glVertexArrayAttribFormat);
DEFINE_FUNC_PTR_TYPE(glVertexArrayVertexBuffer);
DEFINE_FUNC_PTR_TYPE(glVertexArrayAttribBinding);
DEFINE_FUNC_PTR_TYPE(glVertexArrayElementBuffer);
DEFINE_FUNC_PTR_TYPE(glDrawElements);
DEFINE_FUNC_PTR_TYPE(glBindBufferBase);
DEFINE_FUNC_PTR_TYPE(glNamedBufferSubData);
DEFINE_FUNC_PTR_TYPE(glViewport);
DEFINE_FUNC_PTR_TYPE(glEnable);
DEFINE_FUNC_PTR_TYPE(glDisable);
